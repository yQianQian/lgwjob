    ...
    <div id="header">
        <div class="wrapper">
            ...
            <ul id="navheader" class="reset">
                ...
                <li class="current"><a href="h/c/companylist.jsp">公司</a></li>
            ...
            <dl class="c_section c_section_service">
                ...
                <dd>
                    ...
                    <form class="corp_form" id="companyNameForm">
                        ...
                        <a class="goback" href="h/corpCenter/bindStep1.jsp?update=1">返回修改邮箱地址</a>
                    </form>
...
<ul class="ui-autocomplete ui-front ui-menu ui-widget ui-widget-content ui-corner-all" id="ui-id-1" tabindex="0"
    style="display: none; top: 356px; left: 377.5px; width: 590px;">
    <li class="ui-menu-item" role="presentation"><a id="ui-id-3" class="ui-corner-all" tabindex="-1">创建名为"测试公司"的新公司</a>
    </li>
</ul>
</body>
</html>