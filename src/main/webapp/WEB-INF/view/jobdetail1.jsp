...
<head>
    ...
    <title>web前端开发-国馆-拉勾网-最专业的互联网招聘平台</title>
...
<div id="body">
    ...
    <div id="container">
        <div class="clearfix">
            <div class="content_l">
                <dl class="job_detail">
                        ...
                        <div class="dropdown_menu">
                            <div class="drop_l">
                                <img width="131" height="131"
                                     src="style/images/73338ca8e1694b298d223745670f8daf_318969.jpg">
                                <span>[仅限本人使用]</span>
                            </div>
                            <div class="drop_r">
                    ...
                    <dd>
                        ...
                        <a title="投个简历" class="btn fr btn_apply"
                           href="javascript:sendResume(314873,149487,false,false);">投个简历</a>
            ...
            <div class="content_r">
                <dl class="job_company">
                    <dt>
                        <a target="_blank" href="c/19607.jsp">
                            <img width="80" height="80" alt="广东国馆酒业有限公司"
                                 src="style/images/ff80808145ae05750145b0467a1c7ddd.png" class="b2">
                            <div>
                                <h2 class="fl">
                                    国馆
                    ...
                    <dd>
                        <ul class="c_feature reset">
                            ...
                            <li>
                                <span>主页</span>
                                <a rel="nofollow" title="http://www.guoguan.com" target="_blank"
                                   href="http://www.guoguan.com">http://www.guoguan.com</a>
                            </li>
                        </ul>
                        ...
                        <div id="smallmap"
                            ...
                            <div style="overflow: visible; position: absolute; z-index: 0; left: 0px; top: 0px; cursor: grab;">
                                <div class="BMap_mask"
                                     style="position: absolute; left: 0px; top: 0px; z-index: 9; overflow: hidden; width: 280px; height: 200px;"></div>
                                <div style="position: absolute; height: 0px; width: 0px; left: 0px; top: 0px; z-index: 200;">
                                    ...
                                    <div style="position: absolute; height: 0px; width: 0px; left: 0px; top: 0px; z-index: 700;">
                                        <span style="position: absolute; padding: 0px; margin: 0px; border: 0px none; -moz-user-select: none; cursor: pointer; background: url(style/images/img/blank.gifquot) repeat scroll 0% 0% transparent; width: 19px; height: 25px; left: 130px; top: 75px; z-index: -4625058;"
                                        "="" unselectable="on" class="BMap_Marker BMap_noprint" title=""></span></div>
                                    ...
                                    <div style="position: absolute; height: 0px; width: 0px; left: 0px; top: 0px; z-index: 400;">
                                        <span style="position: absolute; padding: 0px; margin: 0px; border: 0px none; width: 0px; height: 0px; -moz-user-select: none; left: 130px; top: 75px; z-index: -4625058;"
                                              unselectable="on" class="BMap_Marker"><div
                                                style="position: absolute; margin: 0px; padding: 0px; width: 19px; height: 25px; overflow: hidden;"><img
                                                style="border:none;margin-left:0px; margin-top:0px; "
                                                src="style/images/marker_red_sprite.png"></div></span></div>
                                    <div style="position: absolute; height: 0px; width: 0px; left: 0px; top: 0px; z-index: 300;">
                                        <span style="position: absolute; padding: 0px; margin: 0px; border: 0px none; width: 20px; height: 11px; -moz-user-select: none; left: 134px; top: 89px;"
                                              unselectable="on"><div
                                                style="position: absolute; margin: 0px; padding: 0px; width: 20px; height: 11px; overflow: hidden;"><img
                                                style="border:none;margin-left:-19px; margin-top:-13px; "
                                                src="style/images/marker_red_sprite.png"></div></span></div>
                                ...
                                <div style="position: absolute; overflow: visible; top: 0px; left: 0px; z-index: 1;">
                                    <div style="position: absolute; overflow: visible; z-index: -100; left: 140px; top: 100px; display: none;"></div>
                                </div>
                                <div style="position: absolute; overflow: visible; top: 0px; left: 0px; z-index: 2; display: block;">
                                    <div style="position: absolute; overflow: visible; top: 100px; left: 140px; z-index: 0; display: block;">
                                        <canvas style="position: absolute; width: 256px; height: 256px; left: -156px; top: -103px; background: none repeat scroll 0% 0% rgb(243, 241, 236);"
                                                width="256" height="256" id="_1_bg_12319_2568_16"></canvas>
                                        <canvas style="position: absolute; width: 256px; height: 256px; left: 100px; top: -103px; background: none repeat scroll 0% 0% rgb(243, 241, 236);"
                                                width="256" height="256" id="_1_bg_12320_2568_16"></canvas>
                                    </div>
                                    <div style="position: absolute; overflow: visible; top: 100px; left: 140px; z-index: 10; display: block;">
                                        <canvas style="position: absolute; width: 256px; height: 256px; left: -156px; top: -103px;"
                                                width="256" height="256" id="_1_poi_12319_2568_16"></canvas>
                                        <canvas style="position: absolute; width: 256px; height: 256px; left: 100px; top: -103px;"
                                                width="256" height="256" id="_1_poi_12320_2568_16"></canvas>
                                    </div>
                                </div>
                            ...
                            <div style="height: 32px; position: absolute; z-index: 30; -moz-user-select: none; bottom: 0px; right: auto; top: auto; left: 1px; display: none;"
                                 class=" anchorBL"><a title="到百度地图查看此区域" target="_blank"
                                                      href="http://map.baidu.com/?sr=1"
                                                      style="outline: medium none;"><img
                            ...
                            <div unselectable="on" class=" BMap_cpyCtrl BMap_noprint anchorBL"
                                ...
                                <span _cid="1" style="display: inline;"><span style="font-size:11px">&copy; 2014 Baidu&nbsp;- Data &copy; <a
                                        style="display:inline;" href="http://www.navinfo.com/"
                                        target="_blank">NavInfo</a> &amp; <a style="display:inline;"
                                                                             href="http://www.cennavi.com.cn/"
                                                                             target="_blank">CenNavi</a> &amp; <a
                ...
                <div id="myRecommend_jd">
                    ...
                    <ul class="reset">
                        <li>
                            <a target="_blank" href="jobs/22194.jsp">
                        ...
                        <li>
                            <a target="_blank" href="jobs/148004.jsp">
                                <span class="f14">产品经理</span>
                        ...
                        <li>
                            <a target="_blank" href="jobs/46793.jsp">
                                <span class="f14">产品经理</span>
                        ...
                        <li>
                            <a target="_blank" href="jobs/99307.jsp">
                                <span class="f14">产品经理</span>
                        ...
                        <li>
                            <a target="_blank" href="jobs/147510.jsp">
                                <span class="f14">产品经理</span>
        ...
        <input type="hidden" id="resend_type" name="type" value="0">
        <input type="hidden" id="jobid" value="149487">
        <input type="hidden" id="companyid" value="19607">
                    ...
                    <tr>
                        <td>
                            <form class="resumeSetForm" id="resumeSetForm">
                                ...
                                <div class="setBtns">
                                    <a class="downloadResume dn" href="nearBy/downloadResume">下载</a> <span
                                        class="dn">|</span>
                                    <a class="reUpload" title="上传附件简历" target="_blank">上传附件简历</a>

                                    <input type="file"
                                           onchange="file_check(this,'nearBy/updateMyResume.json','reUploadResume1')"
                                           id="reUploadResume1" name="newResume"
                        ...
                        <td>
                            <form class="resumeSetForm" id="resumeSendForm">
                                ...
                                <div class="setBtns">
                                    ...
                                    <a class="reUpload" title="上传附件简历" target="_blank">上传附件简历</a>
                                    <input type="file"
                                           onchange="file_check(this,'nearBy/updateMyResume.json','reUploadResume2')"
                                           id="reUploadResume2" name="newResume"
                                           title="支持word、pdf、ppt、txt、wps格式文件，大小不超过10M">
                                </div>
                                <div class="clear"></div>
                                <span style="display:none;" class="error">只支持word、pdf、ppt、txt、wps格式文件，请重新上传</span>
                                <label class="bgPink"><input type="checkbox"
                                                             checked="checked">默认使用此简历直接投递，下次不再提示</label>
                                <span class="setTip error"></span>
                        ...
                        <td align="center">
                            <form>
                                <a class="btn_addPic" href="javascript:void(0);">
                                    <span>选择上传文件</span>
                                    <input type="file"
                                           onchange="file_check(this,'nearBy/updateMyResume.json','resumeUpload')"
                    ...
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="button" value="最高学历" id="select_degree"
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="button" value="工作年限" id="select_workyear"
                                       class="profile_select_190 profile_select_normal">
                            ...
                            <td>
                                ...
                                <input type="button" value="期望工作城市" id="select_expectCity"
                                       class="profile_select_190 profile_select_normal">
                ...
                <table width="100%">
                    ...
                    <tr>
                        <td class="msg">
                            ...
                            <div class="f16 count"><span class="f18 confirm_field">学历、工作年限、期望工作城市</span>与该职位要求不匹配，确认要投递吗？
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
                            <input type="hidden" value="" name="type">
                            <a class="btn" href="javascript:sendResume(314873,149487,true,true);">确认投递</a>
                ...
                <table width="100%">
                    ...
                    <tr class="drawGGJ">
                        <td align="center">
                            ...
                            <p class="font_16 share dn">邀请好友成功注册拉勾，可提升每日投递量 &nbsp;&nbsp; <a target="_blank"
                                                                                            href="share/invite.jsp">邀请好友&gt;&gt;</a>
                            </p>
                        </td>
                    </tr>
                    <tr class="drawQD">
                        ...
                        <td align="center">
                            <form>
                                <a class="btn_addPic" href="javascript:void(0);">
                                    <span>选择上传文件</span>
                                    <input type="file"
                                           onchange="file_check(this,'nearBy/updateMyResume.json','resumeUpload2')"
                                           class="filePrew" id="resumeUpload2" name="newResume" size="3"
                                           title="支持word、pdf、ppt、txt、wps格式文件，大小不超过10M">
                                </a>
                            </form>
                        ...
                        <td align="center">
                            <form>
                                <a class="btn_addPic" href="javascript:void(0);">
                                    <span>选择上传文件</span>
                                    <input type="file"
                                           onchange="file_check(this,'nearBy/updateMyResume.json','resumeUpload1')"
	...
	-->
            <div class="popup" id="resend_success">
                <p>我们已将激活邮件发送至：<a>840389046@qq.com</a>，请点击邮件内的链接完成验证。</p>
            </div><!--/#resend_success-->
            ...
            <div class="popup" id="baiduMap">
                <div id="allmap"
                    ...
                    <div style="overflow: visible; position: absolute; z-index: 0; left: 0px; top: 0px; cursor: grab;">
                        ...
                        <div style="position: absolute; overflow: visible; top: 0px; left: 0px; z-index: 1;"></div>
                    ...
                    <div unselectable="on" class=" BMap_stdMpCtrl BMap_stdMpType0 BMap_noprint anchorTL"
                        ...
                        <div class="BMap_stdMpZoom" style="height: 141px; width: 62px;">
                            ...
                            <div class="BMap_stdMpSlider" style="height: 102px;">
                                ...
                                <div class="BMap_stdMpSliderBgBot" style="top: 91px; height: 15px;"></div>
                                <div title="放置到此级别" class="BMap_stdMpSliderMask"></div>
                                <div title="拖动缩放" class="BMap_stdMpSliderBar" style="cursor: grab; top: 91px;">
                                    <div class="BMap_smcbg"></div>
                                </div>
                            </div>
...
var options = {
    	...
    	"merchantId": "11253",
    	"merchantType": "news",
    	"socialLoginUrl_sina": ctx+"/ologin/auth/sina.jsp",
    	"socialLoginUrl_qq": "",
    	"weiboId_sina": "3619164344010985",
    	"weiboId_qq": "",
    	"socialAllUrl": ctx+"/user/hbzx.jsp",
    	"productId": "149487",
    	"productCategory": "",
    	"productName": "web前端开发",
    	"productArea": "广州",
    	"productPrice": "",
    	"productUrl": ctx+"/jobs/149487.jsp",
...
<script src="style/js/common.js" type="text/javascript"></script> -->
        ...
        <script src="http://api.map.baidu.com/api?v=2.0&amp;ak=3d6a9f4b807441569414b01eecc20959"
                type="text/javascript"></script>
        <script src="http://api.map.baidu.com/getscript?v=2.0&amp;ak=3d6a9f4b807441569414b01eecc20959&amp;services=&amp;t=20140617153133"
                type="text/javascript"></script>
        <script type="text/javascript">
            //百度地图API功能
