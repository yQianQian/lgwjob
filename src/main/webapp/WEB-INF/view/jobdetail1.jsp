                ...
                <dl class="job_company">
                    <dt>
                    	<a target="_blank" href="c/19607.jsp">
                            <img width="80" height="80" alt="广东国馆酒业有限公司" src="style/images/ff80808145ae05750145b0467a1c7ddd.png" class="b2">
                            <div>
                                <h2 class="fl">
                                	                                  		国馆
            		...
            		<ul class="reset">
            				...
            				<a target="_blank" href="jobs/147510.jsp">
				                ...
				                <a class="eventAd" target="_blank" href="subject/s_zhouyou.jsp?utm_source=BD__lagou&amp;utm_medium=&amp;utm_campaign=zhouyou">
...
<!-- 投递简历时  - 设置默认投递简历 -->
	        	...
	        	<td>
                    <form class="resumeSetForm" id="resumeSendForm">
	            		...
	            		<div class="setBtns">
	            				            				<a class="downloadResume dn" href="nearBy/downloadResume">下载</a> <span class="dn">|</span>
            					<a class="reUpload" title="上传附件简历" target="_blank">上传附件简历</a>
	            				            			<input type="file" onchange="file_check(this,'nearBy/updateMyResume.json','reUploadResume2')" id="reUploadResume2" name="newResume" title="支持word、pdf、ppt、txt、wps格式文件，大小不超过10M">
            			</div>
            			<div class="clear"></div>
            			<span style="display:none;" class="error">只支持word、pdf、ppt、txt、wps格式文件，请重新上传</span>
	        	...
	        	<td align="center">
	                <form>
	                    <a class="btn_addPic" href="javascript:void(0);">
	                    	<span>选择上传文件</span>
	                        <input type="file" onchange="file_check(this,'nearBy/updateMyResume.json','resumeUpload')" class="filePrew" id="resumeUpload" name="newResume" size="3" title="支持word、pdf、ppt、txt、wps格式文件，大小不超过10M" tabindex="3">
	                    </a>
	                </form>
	            </td>
	        </tr>
        ...
        <table width="100%">
            <tbody><tr class="drawGGJ">
                <td align="center">
                	...
                	<p class="font_16 share dn">邀请好友成功注册拉勾，可提升每日投递量 &nbsp;&nbsp; <a target="_blank" href="share/invite.jsp">邀请好友&gt;&gt;</a></p>
                </td>
            </tr>
        	<tr class="drawQD">
            	<td align="center"><a class="btn_s" href="javascript:top.location.reload();">确&nbsp;定</a></td>
            ...
            <tr class="weixinQR">
            	<td>
            		<div class="weixin">
                       	<div class="qr">
                       		<img width="120" height="120" src="style/images/73338ca8e1694b298d223745670f8daf_318969.jpg">
	    	...
	    	<tr>
	        	<td align="center">
                   <form>
                        <a class="btn_addPic" href="javascript:void(0);">
                        	<span>选择上传文件</span>
                        	<input type="file" onchange="file_check(this,'nearBy/updateMyResume.json','resumeUpload2')" class="filePrew" id="resumeUpload2" name="newResume" size="3" title="支持word、pdf、ppt、txt、wps格式文件，大小不超过10M">
                        </a>
                    </form>
        	...
        	<tr>
            	<td align="center">
                    <form>
                        <a class="btn_addPic" href="javascript:void(0);">
                        	<span>选择上传文件</span>
                        	<input type="file" onchange="file_check(this,'nearBy/updateMyResume.json','resumeUpload1')" class="filePrew" id="resumeUpload1" name="newResume" size="3" title="支持word、pdf、ppt、txt、wps格式文件，大小不超过10M">
                        </a>
                    </form>
                </td>
            </tr>
	...
	<div style="height:240px;" class="popup" id="activePop">
       	...
       	<p>我们已将验证邮件发送至：<a>840389046@qq.com</a>，请点击邮件内的链接完成验证。</p>
                <p><a id="resend" href="javascript:void(0)">重新发送验证邮件 </a> | <a target="_blank" href="register.jsp"> 换个邮箱？ </a>  	</p>
    </div><!--/#activePop-->    
