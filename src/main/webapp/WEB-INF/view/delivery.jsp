    ...
    <div id="header">
        <div class="wrapper">
            ...
            <dl class="collapsible_menu">
                ...
                <dd style="display: none;"><a rel="nofollow" href="jianli.jsp">我的简历</a></dd>
                <dd style="display: none;"><a href="collections.jsp">我收藏的职位</a></dd>
                <dd style="display: none;"><a href="toudi.jsp">我投递的职位 <span id="noticeNo" class="red dn">(0)</span></a></dd>
                <dd class="btm" style="display: none;"><a href="subscribe.jsp">我的订阅</a></dd>
        ...
        <div class="clearfix">
                ...
                <dl class="c_delivery">
                    ...
                    <dd>
                        <div class="delivery_tabs">
                            <ul class="reset">
                                <li class="current">
                                    <a href="delivery.jsp?tag=-1">全部</a>
                                </li>
                                <li>
                                    <a href="delivery.jsp?tag=5">投递成功</a>
                                </li>
                                <li>
                                    <a href="delivery.jsp?tag=1">被查看</a>
                                </li>
                                <li>
                                    <a href="delivery.jsp?tag=2">通过初筛</a>
                                </li>
                                <li>
                                    <a href="delivery.jsp?tag=3">通知面试</a>
                                </li>
                                <li class="last">
                                    <a href="delivery.jsp?tag=4">不合适</a>
                                </li>
                            </ul>
                        </div>
                            ...
                            <ul class="reset my_delivery">
                                <li>
                                    <div class="d_item">
                                        ...
                                        <div class="clear"></div>
                                        <a title="公司名称" class="d_jobname" target="_blank" href="http://www.lagou.com/c/25927.jsp">
                                            公司名称 <span>[上海]</span>
                                        </a>
            ...
            <div class="content_r">
                <div class="mycenterR" id="myInfo">
                    ...
                    <br>
                    <a href="toudi.jsp" target="_blank">我投递的职位<span id="noticeNoPage" class="red dn">&nbsp;(0)</span></a>
                    <br>
                    <a target="_blank" href="subscribe.jsp">我订阅的职位</a>
                    <br>
                    <a target="_blank" href="mList.jsp">我的职位推荐</a>
                </div><!--end #myInfo-->
