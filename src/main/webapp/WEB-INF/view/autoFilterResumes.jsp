	...
	<dd>
		<a href="positions.jsp">已下线职位</a>
            ...
            <div class="content">
            	<dl class="company_center_content">
                    ...
                    <dd>
                    	<form action="autoFilterResumes.jsp" method="get" id="filterForm">
     ...
     <input type="hidden" value="" name="positionId" id="positionId">
			                                ...
			                                <div class="resumeShow">
			                                        ...
			                                        <h3 class="unread">
			                                        				                                        	<a target="_blank" title="预览jason的简历" href="resumeView.jsp?deliverId=1686182">
			                                        			                                            		jason的简历
		                                        		</a>
				                           	 							                           	 			<em></em>
			                                        </h3>
			                                        ...
			                                        <div class="jdpublisher">
				                                        <span>
				                                        	应聘职位：<a title="随便写" target="_blank" href="http://www.lagou.com/jobs/149594.jsp">随便写</a>
				                                       						                                        </span>
			                                        </div>
			                                    </div>
			                                    <div class="links">
