                    ...
                    <dd>
                        <form id="collectionsForm">
                            <ul class="reset my_collections">
                                <li data-id="133340">
                                    <a title="携程旅行网" target="_blank" href="h/c/6636.jsp">
                                        <img alt="携程旅行网" src="style/images/ff808081441c19bf01441f9a47190b3a.png">
                                    </a>
                                    <div class="co_item">
                                        <h2 title="酒店业务助理">
                                            <a target="_blank" href="h/jobs/133340.jsp">
                                                <em>酒店业务助理</em>
                                                <span>（4k以上）</span>
                                            </a>
                                        </h2>
                                        ...
                                        <a class="collection_link" target="_blank" href="h/jobs/133340.jsp">投个简历</a>
                                        <i></i>
                                ...
                                <li data-id="148886">
                                    <a title="蘑菇街" target="_blank" href="h/c/108.jsp">
                                        <img alt="蘑菇街" src="style/images/ff80808142a8df050142b1674c596676.jpg">
                                    </a>
                                    <div class="co_item">
                                        <h2 title="PHP">
                                            <a target="_blank" href="h/jobs/148886.jsp">
                                                <em>PHP</em>
                                                <span>（15k-30k）</span>
                                            </a>
                                        </h2>
                                        ...
                                        <a class="collection_link" target="_blank" href="h/jobs/148886.jsp">投个简历</a>
                                        <i></i>
                                        <a class="collectionCancel collection_link collected" href="javascript:;">
                                            取消收藏
                                            <span>已取消收藏</span>
                                ...
                                <li data-id="148519">
                                    <a title="搜狗" target="_blank" href="h/c/1537.jsp">
                                        <img alt="搜狗" src="style/images/ff80808142e0968f0142e0d41f1205f2.jpg">
                                    </a>
                                    <div class="co_item">
                                        <h2 title="商家运营">
                                            <a target="_blank" href="h/jobs/148519.jsp">
                                                <em>商家运营</em>
                                                <span>（8k-16k）</span>
                                            </a>
                                        </h2>
                                        ...
                                        <a class="collection_link" target="_blank" href="h/jobs/148519.jsp">投个简历</a>
                                        <i></i>
                                        <a class="collectionCancel collection_link collected" href="javascript:;">
                                            取消收藏
                                            <span>已取消收藏</span>
