        ...
        <div class="content">
            <div id="search_box">
                <form id="searchForm" name="searchForm" action="/list.do" method="get">
                    ...
                    <input type="text" id="search_input" name="kd" tabindex="1" value="前端开发"
            ...
            <dl class="hotSearch">
                <dt>热门搜索：</dt>
                <dd><a href="list.jspJava?labelWords=label&city=全国">Java</a></dd>
                <dd><a href="list.jspPHP?labelWords=label&city=全国">PHP</a></dd>
                <dd><a href="list.jspAndroid?labelWords=label&city=全国">Android</a></dd>
                <dd><a href="list.jspiOS?labelWords=label&city=全国">iOS</a></dd>
                <dd><a href="list.jsp前端?labelWords=label&city=全国">前端</a></dd>
                <dd><a href="list.jsp产品经理?labelWords=label&city=全国">产品经理</a></dd>
                <dd><a href="list.jspUI?labelWords=label&city=全国">UI</a></dd>
                <dd><a href="list.jsp运营?labelWords=label&city=全国">运营</a></dd>
                <dd><a href="list.jspBD?labelWords=label&city=全国">BD</a></dd>
                <dd><a href="list.jsp?gx=实习&city=全国">实习</a></dd>
            </dl>
            ...
            <ul class="hot_pos reset">
                <li class="odd clearfix">
                    <div class="hot_pos_l">
                        <div class="mb10">
                            <a href="h/jobs/86989.jsp" title="前端开发" target="_blank">前端开发</a>
                            &nbsp;
                ...
                <li class="clearfix">
                    <div class="hot_pos_l">
                        <div class="mb10">
                            <a href="h/jobs/114177.jsp" title="前端开发" target="_blank">前端开发</a>
                            &nbsp;
                            <span class="c9">[北京]</span>
                        </div>
                ...
                <li class="odd clearfix">
                    <div class="hot_pos_l">
                        <div class="mb10">
                            <a href="h/jobs/95531.jsp" title="高级web前端开发工程师" target="_blank">高级web前端开发工程师</a>
                            &nbsp;
                ...
                <li class="clearfix">
                    <div class="hot_pos_l">
                        <div class="mb10">
                            <a href="h/jobs/137964.jsp" title="前端开发" target="_blank">前端开发</a>
                            &nbsp;
                ...
                <li class="odd clearfix">
                    <div class="hot_pos_l">
                        <div class="mb10">
                            <a href="h/jobs/129304.jsp" title="前端开发" target="_blank">前端开发</a>
                            &nbsp;
                            <span class="c9">[上海]</span>
                        </div>
                ...
                <li class="clearfix">
                    <div class="hot_pos_l">
                        <div class="mb10">
                            <a href="h/jobs/52373.jsp" title="前端开发" target="_blank">前端开发</a>
                            &nbsp;
                            <span class="c9">[上海]</span>
                        </div>
                ...
                <li class="odd clearfix">
                    <div class="hot_pos_l">
                        <div class="mb10">
                            <a href="h/jobs/83325.jsp" title="前端开发" target="_blank">前端开发</a>
                            &nbsp;
                ...
                <li class="clearfix">
                    <div class="hot_pos_l">
                        <div class="mb10">
                            <a href="h/jobs/56965.jsp" title="前端开发" target="_blank">前端开发</a>
                            &nbsp;
                            <span class="c9">[北京]</span>
                        </div>
                ...
                <li class="odd clearfix">
                    <div class="hot_pos_l">
                        <div class="mb10">
                            <a href="h/jobs/4801.jsp" title="前端开发工程师" target="_blank">前端开发工程师</a>
                            &nbsp;
                            <span class="c9">[上海]</span>
                        </div>
                    ...
                    <div class="hot_pos_r">
                        <div class="apply">
                            <a href="h/jobs/4801.jsp" target="_blank">投个简历</a>
                        </div>
                ...
                <li class="clearfix">
                    <div class="hot_pos_l">
                        <div class="mb10">
                            <a href="h/jobs/33058.jsp" title="前端开发工程师实习生" target="_blank">前端开发工程师实习生</a>
                            &nbsp;
                            <span class="c9">[上海]</span>
                        </div>
                ...
                <li class="odd clearfix">
                    <div class="hot_pos_l">
                        <div class="mb10">
                            <a href="h/jobs/39231.jsp" title="JS前端开发工程师-北京-01899" target="_blank">JS前端开发工程师-北京-01899</a>
                            &nbsp;
                            <span class="c9">[北京]</span>
                        </div>
                        <span><em class="c7">月薪：</em>10k-20k</span>
                ...
                <li class="clearfix">
                    <div class="hot_pos_l">
                        <div class="mb10">
                            <a href="h/jobs/112562.jsp" title="资深JS前端开发工程师-北京-02398" target="_blank">资深JS前端开发工程师-北京-02398</a>
                            &nbsp;
                            <span class="c9">[北京]</span>
                        </div>
                ...
                <li class="odd clearfix">
                    <div class="hot_pos_l">
                        <div class="mb10">
                            <a href="h/jobs/73943.jsp" title="前端开发工程师" target="_blank">前端开发工程师</a>
                            &nbsp;
                            <span class="c9">[北京]</span>
                        </div>
                ...
                <li class="clearfix">
                    <div class="hot_pos_l">
                        <div class="mb10">
                            <a href="h/jobs/134193.jsp" title="前端开发工程师" target="_blank">前端开发工程师</a>
                            &nbsp;
                    ...
                    <div class="hot_pos_r">
                        <div class="apply">
                            <a href="h/jobs/134193.jsp" target="_blank">投个简历</a>
                        </div>
                        <div class="mb10"><a href="h/c/3564.jsp" title="同程旅游" target="_blank">同程旅游</a></div>
                ...
                <li class="odd clearfix">
                    <div class="hot_pos_l">
                        <div class="mb10">
                            <a href="h/jobs/62007.jsp" title="web前端开发工程师/主管" target="_blank">web前端开发工程师/主管</a>
                            &nbsp;
                    ...
                    <div class="hot_pos_r">
                        <div class="apply">
                            <a href="h/jobs/62007.jsp" target="_blank">投个简历</a>
                        </div>
                        <div class="mb10"><a href="h/c/12185.jsp" title="蝶讯网" target="_blank">蝶讯网</a></div>
        ...
        <script>
            $(function () {
                ...
                $('#options dd div').click(function () {
                    ...
                    if (fn == "月薪范围") {
                        editForm("yxInput", $(this).jsp());
                    } else if (fn == "工作经验") {
                        editForm("gjInput", $(this).jsp());
                    } else if (fn == "最低学历") {
                        editForm("xlInput", $(this).jsp());
                    } else if (fn == "工作性质") {
                        editForm("gxInput", $(this).jsp());
                    } else if (fn == "发布时间") {
                        editForm("stInput", $(this).jsp());
                    }
                });
                ...
                (function ($) {
                    ...
                    $('.hot_pos li').each(function () {
                        ...
                        $('.hot_pos_l a', this).jsp(resultL.join(''));
                        ...
                        $('.hot_pos_r .mb10 a', this).jsp(resultR.join(''));
                    });
            ...
            function editForm(inputId, inputValue) {
                ...
                if (kw == '') {
                    $('#searchForm').attr('action', 'list.jsp所有职位').submit();
                } else {
                    kw = kw.replace(re, '井');
                    kw = kw.replace(r, '。');
                    $('#searchForm').attr('action', 'list.jsp' + kw).submit();
                }
                //$("#searchForm").submit();
            }
        </script>
