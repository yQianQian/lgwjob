...
<div id="body">
    ...
    <div id="container">
        <div class="clearfix">
            <div class="content_l">
                <dl class="job_detail">
                    ...
                    <dd class="job_bt">
                        ...
                        <p>岗位职责： <br/>1、参与管理和维护立方网，保证网络社区健康、有序地运转，负责网站信息安全； <br/>2、强化团队建设，提高团队工作效率，做好领导与员工直接沟通的桥梁； <br/>3、制定和完善客服体系规章制度,培训新人。
                        </p>
                        <p>&nbsp;岗位要求： <br/>1、2年以上互联网行业客服主管工作经验，本科及以上学历； <br/>2、良好的沟通和协调能力、人际交往能力和语言表达能力； <br/>3、较强的责任心和执行力，富有工作热情和团队协作能力。
                        </p>
                    </dd>
            ...
            <div class="content_r">
                <dl class="job_company">
                    <dt>
                        <a href="h/c/683.jsp" target="_blank">
                            <img class="b2" src="style/images/ff80808140ac5ed90140b953972e0215.png" width="80"
                                 height="80" alt="北京立方网信息技术有限公司"/>
                            <div>
                                <h2 class="fl">
                                    立方网
                ...
                <a href="h/subject/s_zhouyou.jsp?utm_source=BD__lagou&utm_medium=&utm_campaign=zhouyou" target="_blank"
                   class="eventAd">
        ...
        <div style="display:none;">
                        ...
                        <td>
                            <form id="resumeSetForm" class="resumeSetForm">
                                ...
                                <div class="setBtns">
                                    ...
                                    <input title="支持word、pdf、ppt、txt、wps格式文件，大小不超过10M" name="newResume"
                                           id="reUploadResume1"
                                           type="file"
            ...
            <div id="uploadFile" class="popup">
                <table width="100%">
                            ...
                            <form>
                                <a href="javascript:void(0);" class="btn_addPic">
                                    ...
                                    <input tabindex="3" title="支持word、pdf、ppt、txt、wps格式文件，大小不超过10M" size="3"
                                           name="newResume" id="resumeUpload"
                    ...
                    <tr>
                        <td align="center"><img src="style/images/loading.gif" width="55" height="16" id="loadingImg"
                ...
                <table width="100%">
                    <tr class="drawGGJ">
                        <td align="center">
                            ...
                            <p class="font_16 share dn">邀请好友成功注册拉勾，可提升每日投递量 &nbsp;&nbsp; <a href="h/share/invite.jsp"
        ...
        var options = {
                ...
                "productArea": "武汉",
                "productPrice": "",
                "productUrl": ctx+"/jobs/140204.jsp",
