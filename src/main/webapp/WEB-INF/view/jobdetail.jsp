...
<p>&nbsp;岗位要求： <br />1、2年以上互联网行业客服主管工作经验，本科及以上学历； <br />2、良好的沟通和协调能力、人际交往能力和语言表达能力； <br />3、较强的责任心和执行力，富有工作热情和团队协作能力。</p>
                                        	...
                                        	<dd class="unresume">
	                        <div>
	                        	你在拉勾还没有简历呢，你可以<a href="login.jsp" target="_blank" title="完善在线简历">完善在线简历</a>，也可<a class="inline" href="#loginPop" title="登录">上传附件简历</a>直接投递
	                       	</div>
	                    </dd>
                    ...
                    <dd>
                        ...
                        <div id="addLabel" class="addLabel dn">
                       	...
                       	<a href="javascript:;" id="mapPreview">查看完整地图</a>
                                ...
                                <a href="h/subject/s_zhouyou.jsp?utm_source=BD__lagou&utm_medium=&utm_campaign=zhouyou" target="_blank" class="eventAd">
      ...
      <input type="hidden" value="" id="positionLat" />
		...
		<div>
			...
			<div class="right">
				<a href="register.jsp?from=jobs_footerbar" onclick="_hmt.push(['_trackEvent', 'button', 'click', 'register'])" class="bar_register" id="bar_register" target="_blank"><i></i></a>
			</div>
...
<!-- 投递简历时  - 设置默认投递简历 -->
        ...
        <table width="100%">
            <tr class="drawGGJ">
                <td align="center">
                	...
                	<p class="font_16 share dn">邀请好友成功注册拉勾，可提升每日投递量 &nbsp;&nbsp; <a href="h/share/invite.jsp" target="_blank">邀请好友>></a></p>
                </td>
            </tr>
        	<tr class="drawQD">
            	<td align="center"><a href="javascript:top.location.reload();" class="btn_s">确&nbsp;定</a></td>
	...
	<div id="activePop" class="popup" style="height:240px;">
       	...
       	<p>我们已将验证邮件发送至：<a></a>，请点击邮件内的链接完成验证。</p>
                <p><a href="javascript:void(0)" id="resend">重新发送验证邮件 </a> | <a href="register.jsp" target="_blank"> 换个邮箱？ </a>  	</p>
    </div><!--/#activePop-->    
