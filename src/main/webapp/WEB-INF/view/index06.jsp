...
<link href="style/css/jiathis_share.css" rel="stylesheet" type="text/css">
...
<iframe frameborder="0" style="display: none;" src="http://v3.jiathis.com/code_mini/jiathis_utility.jsp"></iframe>
<div id="body">
    <div id="header">
        <div class="wrapper">
    ...
    <div id="container">
                    ...
                    <div class="weixin weixinSuc">
                        <div class="qr">
                            <img width="110" height="110"
                                 src="style/images/d1f91afa15eb451eaef4d14dcb3b54ec_318969.jpg">
                            <div>[仅限本人使用]</div>
                        </div>
                        <div class="qr_text">
                            <h3>关注微信服务号，可随时获取接收简历的通知 </h3>
                            关注方式：<br>
                            <span>打开微信 </span> <img width="30" height="30" src="style/images/wx1.png"><span> →发现 </span>
                            <img width="31" height="30" src="style/images/wx2.png"><span> →扫一扫左侧二维码</span><img
                                width="78" height="29" src="style/images/wx3.png">
                        </div>
                    </div>
                </dd>
            </dl>
        ...
        <script type="text/javascript">
            var jiathis_config = {
                summary: "【公司名称随便写招聘随便写】我们公司正在招聘随便写，月薪1k-2k，如果你对这个职位感兴趣，请进入详情页投递简历：http://www.lagou.com/jobs/149594.jsp @拉勾网",
                boldNum: 6,
                title: "#拉勾网热招职位#",
                url: "http://www.lagou.com/jobs/149594.jsp",
                hideMore: !0,
                appkey: {tsina: "3761453225"},
                pic: "",
                evt: {share: ""}
            };
            popQR();
