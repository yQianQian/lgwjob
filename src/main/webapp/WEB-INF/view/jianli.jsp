                        ...
                        <form id="profileForm">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <input type="text" placeholder="接收面试通知的邮箱" value="jason@qq.com" name="email"
                                               id="email">
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <table>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <input type="button" value="期望城市，如：北京" id="select_expectCity"
                        ...
                        <form class="experienceForm borderBtm dn">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" placeholder="职位名称，如：产品经理" name="positionName"
                                               class="positionName">
                                    </td>
                                </tr>
                                <tr>
